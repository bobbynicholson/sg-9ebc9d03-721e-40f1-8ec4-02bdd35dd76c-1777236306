...
export const CORE_CHAT_INTENTS: readonly ChatIntentDefinition[] = [
  ...
  { id: "cleaning.work", domain: "cleaning", action: "read", entity: "cleaning_work", roles: ["cleaning_manager", "cleaning_staff"], toolIds: ["cleaning_work_tasks", "cleaning_equipment", "cleaning_supplies", "cleaning_damage_reports", "cleaning_schedules", "daily_operations_tasks"], navigationRefs: ["cleaning.dashboard", "cleaning.tasks", "cleaning.equipment", "cleaning.supplies", "cleaning.workflows", "cleaning.schedules", "cleaning.damage", "cleaning.dashboard.verification", "cleaning.dashboard.damages"], phrases: ["cleaning work", "cleaning tasks", "equipment to clean", "damage reports", "returns", "washing", "inspections", "cleaning schedule", "cleaning supplies", "cleaning workflow", "unresolved cleaning damage", "cleaning jobs by status"], keywords: ["cleaning", "equipment", "damage", "tasks", "inspection", "return", "washing", "wash", "schedule", "handover", "supplies", "detergent", "SOP", "unresolved", "status"], priority: 90, description: "Cleaning tasks, returned equipment, washing, inspections, supplies, handovers, schedules, and damage reports." },
  { id: "cleaning.duty", domain: "cleaning", action: "read", entity: "cleaning_duty", roles: ["cleaning_manager", "cleaning_staff"], toolIds: ["work_clock_status", "work_hours"], navigationRefs: ["cleaning.dashboard"], phrases: ["cleaning clock in", "cleaning clock out", "cleaner shift", "cleaning work hours"], keywords: ["clock", "clocking", "shift", "hours", "duty", "on duty", "off duty"], priority: 95, description: "Cleaning shift clock-in/out and recorded work hours." },
  { id: "cleaning.management", domain: "cleaning", action: "read", entity: "cleaning_team", roles: ["cleaning_manager"], toolIds: ["team_roster", "work_clock_status", "work_hours", "staff_shift_schedule", "cleaning_work_tasks", "user_notifications"], navigationRefs: ["cleaning.management", "cleaning.tasks", "cleaning.schedules", "cleaning.dashboard"], phrases: ["cleaning team", "cleaning staff roster", "who is on duty in cleaning", "cleaning assignments", "unassigned cleaning work", "cleaning team schedule"], keywords: ["cleaning team", "cleaning staff", "roster", "assignments", "assigned", "unassigned", "on duty", "team schedule"], priority: 105, description: "Cleaning manager team roster, duty status, assignments, schedules, and work-hour oversight." },

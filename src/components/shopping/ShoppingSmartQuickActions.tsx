...
export function ShoppingSmartQuickActions({ onNavigate }: ShoppingSmartQuickActionsProps) {
  ...
  const ACTIONS_BY_MODE = {
    quiet: [
      ...
      { href: "/team-portal/shopping/inventory",      label: "Inventory",      sub: "Stock levels",          icon: Warehouse, accent: "from-emerald-500 to-teal-500" },
    ...
    reconcile: [
      ...
      { href: "/team-portal/shopping/invoices",       label: "Spend today",    sub: "Match totals",          icon: Wallet,    accent: "from-blue-500 to-indigo-500" },
      { href: "/team-portal/shopping/suppliers",      label: "Suppliers",      sub: "Confirm contacts",      icon: Users,     accent: "from-purple-500 to-pink-500" },
    ],
  } as const;

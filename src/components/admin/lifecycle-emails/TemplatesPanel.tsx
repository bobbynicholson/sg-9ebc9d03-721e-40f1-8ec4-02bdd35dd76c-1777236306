...
/**
 * TemplatesPanel -- the messaging templates editor body.
 *
 * Extracted from /admin/messaging-templates (which the legacy
 * /admin/email-templates redirected to) so the same surface mounts
 * inside the Lifecycle Emails hub's "Templates" tab.
 *
 * Pure component: no AdminNav / NoIndexMeta / Head / page header --
 * those are page concerns. This is just the content.
 */
...
import { Mail, MessageCircle, Pencil, RotateCcw, Save, AlertCircle, CheckCircle2 } from "lucide-react";

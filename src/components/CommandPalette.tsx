...
export function CommandPalette() {
  ...
  const allItems = useMemo<PaletteItem[]>(() => [
    ...
    { id: "go-driver-set",  label: "Driver Settlement",   icon: DollarSign,   href: "/admin/driver-settlement",   group: "Navigate", roles: ["admin","company_admin","owner"], keywords: ["pay","driver"] },

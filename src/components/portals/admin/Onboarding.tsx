...
export default function Onboarding({ companySlug }: OnboardingProps) {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 lg:pl-64 xl:pl-72">
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 mt-3">
                            <Link href={item.actionUrl.replace('/admin/', `/${companySlug}/admin/`)} passHref>

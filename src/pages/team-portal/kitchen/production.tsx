      ...
      <main className="min-h-screen overflow-x-hidden bg-gradient-to-br from-slate-50 via-white to-orange-50 lg:pl-72 xl:pl-80 pt-16 lg:pt-0">
        <div className="px-3 sm:px-4 md:px-6 py-6 sm:py-8 max-w-full">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-6">
            <Card><CardContent className="p-4"><p className="text-xs text-slate-600">Events this week</p><p className="text-2xl font-bold tabular-nums">{totals.events}</p></CardContent></Card>
            <Card><CardContent className="p-4"><p className="text-xs text-slate-600">Total guests</p><p className="text-2xl font-bold tabular-nums">{totals.guests}</p></CardContent></Card>
            <Card><CardContent className="p-4"><p className="text-xs text-slate-600">Total portions</p><p className="text-2xl font-bold tabular-nums">{totals.dishes}</p></CardContent></Card>
          </div>

...
function DriverDashboardInner() {
  ...
  // Semantic status tints only: emerald = delivered/ready (success),
  // amber = en-route/in-flight (warning), slate = assigned/neutral.
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "en_route":
      case "picked_up":
        return "bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-500/10 dark:text-amber-300 dark:border-amber-900";
      case "delivered":
      case "completed":
        return "bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-300 dark:border-emerald-900";
      default:
        ...
        <PortalShell className="min-h-0 bg-transparent dark:bg-transparent">
          ...
          <div className="mb-4 sm:mb-6 md:mb-8">
              ...
              <div>
                ...
                {!loading && jobs.length > 0 && (
                  <Link
                    ...
                    className="mt-2 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-amber-200 bg-amber-50 text-sm font-medium text-amber-700 hover:bg-amber-100 transition-colors duration-150 dark:border-amber-900 dark:bg-amber-950 dark:text-amber-300 dark:hover:bg-amber-900/60"
                  >
            ...
            {!loading && jobs.length > 0 && (() => {
              ...
              return (
                <PortalCard className="mb-4 sm:mb-6 border-l-4 border-l-amber-500">
                  <p className="text-xs sm:text-sm uppercase tracking-wide font-semibold text-amber-700 dark:text-amber-400 mb-1.5">Next pickup</p>
                  <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
                    ...
                    {nextPickup.client_phone && (
                      <a
                        ...
                        className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-amber-600 text-white font-semibold min-h-11 hover:bg-amber-700 transition-colors duration-150"
                      >
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="text-left sm:text-right w-full sm:w-auto">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl border border-slate-200 bg-slate-50 flex items-center justify-center mb-2 mx-auto sm:mx-0 dark:border-slate-700 dark:bg-slate-800">
                    <TrendingUp className="w-7 h-7 sm:w-8 sm:h-8 text-amber-600 dark:text-amber-500" />
                  </div>
              ...
              <div className="space-y-2 sm:space-y-3">
                  {loading ? (
                    ...
                    jobs.map((job) => (
                      <div
                        key={job.id}
                        className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-xl border border-slate-200 hover:border-amber-400 transition-colors duration-150 dark:border-slate-700 dark:bg-slate-900 dark:hover:border-amber-600"
                      >
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-2 mb-2">
                            ...
                            <Link
                              ...
                              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-semibold text-amber-700 bg-amber-50 border border-amber-200 hover:bg-amber-100 transition-colors duration-150 dark:text-amber-300 dark:bg-amber-950 dark:border-amber-900 dark:hover:bg-amber-900/60"
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {["ready", "in_transit", "delivered"].includes(job.status) && (
                            <Button
                              className="flex-1 sm:flex-none min-h-11 px-3 text-sm bg-amber-600 hover:bg-amber-700 text-white gap-1"
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              <MessageCircle className="w-5 h-5 text-amber-600 dark:text-amber-500" />

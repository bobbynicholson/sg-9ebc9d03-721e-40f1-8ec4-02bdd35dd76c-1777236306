                ...
                {tripStarted && completedStops === route.stops.length && !tripCompleted && (
                  <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-800">
                    <Button
                      ...
                      className="w-full bg-brand-accent hover:opacity-90 text-white"
                    >
                    ...
                    <>
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          <div className="w-8 h-8 rounded-full bg-brand-accent text-white flex items-center justify-center font-semibold tabular-nums">
                            {currentStopIndex + 1}
                          </div>
                      ...
                      {(() => {
                        ...
                        return (
                          <>
                            {!stopIsRolling && (
                              <div className="rounded-lg p-3 text-sm bg-brand-accent/10 text-brand-accent border border-brand-accent/20 dark:bg-brand-accent/20 dark:text-brand-accent">
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 rounded-xl border transition-colors duration-150 ${
                        isCurrent
                          ? "border-brand-accent/40 bg-brand-accent/10 dark:border-brand-accent/40 dark:bg-brand-accent/20"
                          : isCompleted
                          ...
                          <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold text-lg tabular-nums ${
                              isCompleted
                                ...
                                : isCurrent
                                ? "bg-brand-accent text-white ring-4 ring-brand-accent/20 dark:ring-brand-accent/30"
                          ...
                          <div className="flex items-start justify-between mb-2">
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-1 flex-wrap">
                                ...
                                {isCurrent && (
                                  <Badge className="bg-brand-accent/10 text-brand-accent border border-brand-accent/20 dark:bg-brand-accent/20 dark:text-brand-accent">
                                ...
                                <Badge
                                  className={
                                    stop.priority === 1
                                      ...
                                      : "bg-brand-accent/10 text-brand-accent border border-brand-accent/20 dark:bg-brand-accent/20 dark:text-brand-accent"
                                  }
                                >
                                ...
                                <Link
                                  ...
                                  className="inline-flex items-center gap-1 text-xs px-2 py-1 rounded border border-brand-accent/30 bg-brand-accent/10 hover:bg-brand-accent/5 text-brand-accent font-semibold min-h-[32px] transition-colors duration-150 dark:border-brand-accent/30 dark:bg-brand-accent/20 dark:text-brand-accent"
                              ...
                              <div className="flex gap-2 mt-3">
                                {!rolling && (
                                  <Button
                                    ...
                                    className="flex-1 sm:flex-none bg-brand-accent hover:opacity-90 text-white"
                                  >

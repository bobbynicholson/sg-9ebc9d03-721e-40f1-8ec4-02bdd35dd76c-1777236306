...
const tooltipAuditCards: SprintCard[] = [
  {
    ...
    items: [
      ...
      { title: "Driver schedule shows full orders.total_amount to drivers", detail: "Resolved by the 2026-07-02 driver-portal restructure: /schedule now redirects to the calendar agenda, which deliberately renders no money values.", status: "shipped", ref: "src/pages/team-portal/driver/schedule.tsx" },
    ],
  },
  {
...
const journeyAuditCards: SprintCard[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Driver schedule + deliveries expose customer total_amount to drivers", detail: "Resolved by the 2026-07-02 driver-portal restructure: /schedule redirects to the money-free calendar agenda and the rebuilt deliveries page no longer selects or renders total_amount.", status: "shipped", ref: "src/pages/team-portal/driver/schedule.tsx + src/pages/team-portal/driver/deliveries.tsx" },

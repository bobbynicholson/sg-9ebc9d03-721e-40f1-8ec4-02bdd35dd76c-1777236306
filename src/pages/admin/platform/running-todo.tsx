...
const devOpsCards: SprintCard[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Set TURNSTILE_SECRET_KEY + NEXT_PUBLIC_TURNSTILE_SITE_KEY (optional, recommended pre-launch)", detail: "Sign up free at https://dash.cloudflare.com/sign-up -> Turnstile -> Add Site (Managed mode). Copy both keys. Without these the embed-form + change-request flows fall back to honeypot-only anti-spam, which is enough for soft-launch but Turnstile is recommended once tenants go live.", status: "todo" },

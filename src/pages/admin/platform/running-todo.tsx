...
const productNotesCards: SprintCard[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Audit trail: log every cash_on_hand edit + every forecast snapshot to audit_logs", detail: "Phase 1 (2026-05-18, PR #75) shipped the edit-side audit. Every Save writes an audit_logs row with action='financial.cash_on_hand.update', entity_type='company', entity_id=companyId, details={ old_cents, new_cents, currency }. Phase 2 adds the bookkeeper-facing CSV export of the daily forecast snapshot.", status: "shipped" },

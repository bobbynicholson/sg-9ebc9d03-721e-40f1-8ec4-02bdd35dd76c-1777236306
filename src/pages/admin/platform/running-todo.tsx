...
const journeyAuditCards: SprintCard[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "notificationService.broadcastNotification footgun", detail: "Renamed params.userId -> params.companyId; the function body now correctly stamps company_id on every broadcast row.", status: "done", ref: "src/services/notificationService.ts" },

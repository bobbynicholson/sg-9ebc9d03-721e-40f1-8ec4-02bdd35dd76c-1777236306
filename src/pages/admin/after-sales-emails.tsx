          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
            <Card className="border-0 shadow-lg">
              <CardHeader className="pb-3 px-4 pt-4">
                <CardTitle className="text-sm md:text-base font-medium flex items-center gap-1">Total Email Sequence <InfoTooltip content={"The full after-sales journey is six emails spread across twelve months from the event date."} /></CardTitle>
              </CardHeader>
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader className="pb-3 px-4 pt-4">
                <CardTitle className="text-sm md:text-base font-medium flex items-center gap-1">Email Frequency <InfoTooltip content={"Emails go out roughly every two months, keeping you in front of past clients without overdoing it."} /></CardTitle>
              </CardHeader>
              <CardContent className="px-4 pb-4">

      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 lg:pl-64 xl:pl-72">
        <div className="container mx-auto px-4 py-8 max-w-7xl">
          <div className="mb-8 flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-slate-900 mb-2">After-Sales Emails</h1>
              <p className="text-slate-600">Manage follow-up communications with clients</p>
            </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Automated post-event communications</CardDescription>
                </div>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-slate-500 mb-4">No after-sales campaigns yet</p>

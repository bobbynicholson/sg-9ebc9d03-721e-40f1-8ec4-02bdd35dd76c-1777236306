        ...
        <main className="container mx-auto px-4 py-12 sm:py-16 max-w-3xl">
          <Reveal>
            <div className="mb-10 space-y-3">
              <Eyebrow icon={FileText} className="w-fit border-violet-200 bg-violet-50 text-violet-700">
                Terms of service
              </Eyebrow>
              <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight text-slate-900">Terms &amp; Conditions</h1>
            </div>
          </Reveal>

          <div className="prose prose-slate max-w-none space-y-8 prose-headings:tracking-tight prose-h2:scroll-mt-24">
            <Reveal>
              <section>
            ...
            <Reveal>
              <section>
                ...
                <p className="text-slate-700 leading-relaxed mb-3">
                  If you have any questions about these Terms of Service, please contact us. You can also learn more about our platform on our <Link href="/blog" className="text-violet-600 underline decoration-violet-200 underline-offset-2 transition-colors duration-150 hover:text-violet-700 hover:decoration-violet-400">blog</Link> or explore <Link href="/features" className="text-violet-600 underline decoration-violet-200 underline-offset-2 transition-colors duration-150 hover:text-violet-700 hover:decoration-violet-400">detailed features</Link>:
                </p>
                <div className={`mt-4 p-4 bg-slate-50 rounded-xl border border-slate-200/70 transition-colors duration-300 ${EASE} hover:border-violet-200`}>
            ...
            <Reveal>
              <section className="mt-8 pt-6 border-t">
                <p className="text-sm text-slate-600">
                  By using the Catering Management Platform, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service, including all subscription management, billing, cancellation, and data deletion policies. For additional information, visit our <Link href="/" className="text-violet-600 underline decoration-violet-200 underline-offset-2 transition-colors duration-150 hover:text-violet-700 hover:decoration-violet-400">homepage</Link> or review our <Link href="/privacy" className="text-violet-600 underline decoration-violet-200 underline-offset-2 transition-colors duration-150 hover:text-violet-700 hover:decoration-violet-400">Privacy Policy</Link>.
                </p>

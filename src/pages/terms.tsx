        ...
        <main className="container mx-auto px-4 py-12 sm:py-16 max-w-3xl">
          <Reveal>
            <div className="mb-10 space-y-3">
              <Eyebrow icon={FileText} className="w-fit border-slate-200 bg-slate-50 text-slate-700">
                Terms of service
              </Eyebrow>
          ...
          <div className="prose prose-slate max-w-none space-y-8 prose-headings:tracking-tight prose-h2:scroll-mt-24">
            ...
            <Reveal>
              <section>
                ...
                <p className="text-slate-700 leading-relaxed mb-3">
                  If you have any questions about these Terms of Service, please contact us. You can also learn more about our platform on our <Link href="/blog" className="text-slate-600 underline decoration-slate-200 underline-offset-2 transition-colors duration-150 hover:text-slate-700 hover:decoration-slate-400">blog</Link> or explore <Link href="/features" className="text-slate-600 underline decoration-slate-200 underline-offset-2 transition-colors duration-150 hover:text-slate-700 hover:decoration-slate-400">detailed features</Link>:
                </p>
                <div className={`mt-4 p-4 bg-slate-50 rounded-xl border border-slate-200/70 transition-colors duration-300 ${EASE} hover:border-slate-200`}>
